import { Bus, Chip, Nand } from "./chip";
...
export const And = () => {
	...
	andChip.wire(
		new Nand(),
		[{ from: "a", to: "a" }, { from: "b", to: "b" }, { from: n, to: "out" }],
	);
	andChip.wire(Not(), [{ from: n, to: "in" }, { from: "out", to: "out" }]);
...
export const Or = () => {
	...
	orChip.wire(Not(), [{ from: "a", to: "in" }, { from: notA, to: "out" }]);
	orChip.wire(Not(), [{ from: "b", to: "in" }, { from: notB, to: "out" }]);
	orChip.wire(
		new Nand(),
		[
			{ from: notA, to: "a" },
...
export const Xor = () => {
	...
	xorChip.wire(Not(), [{ from: "a", to: "in" }, { from: notA, to: "out" }]);
	xorChip.wire(Not(), [{ from: "b", to: "in" }, { from: notB, to: "out" }]);
	xorChip.wire(
		And(),
		[
			{ from: "a", to: "a" },
