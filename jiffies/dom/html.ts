...
export const dir = makeHTMLElement("dir");
...
export const font = makeHTMLElement("font");
export const footer = makeHTMLElement("footer");
export const form = makeHTMLElement("form");
export const frame = makeHTMLElement("frame");
export const frameset = makeHTMLElement("frameset");
...
export const marquee = makeHTMLElement("marquee");
