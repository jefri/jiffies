/**
 * @template T
 * @param {import("./result.js").Option<T>} s
 * @returns {s is None} */
 ...
 */ /**
 * @param {T} t
 * @returns {import("./result.js").Option<T>}
 */
export const Some = (t) => {
  return t ? t : None();
};
 ...
 * @param {import("./result.js").Result<T, E>} t
 * @returns {t is import("./result.js").Ok<T>}
 */
export const isOk = (t) => t.ok !== undefined;

/**
 * @template {Error} E
 * @param {import("./result.js").Result<unknown, E>} e
 * @returns {e is Err<E>}
 */
...
/**
 * @template {Error} E
 * @param {E|import("./result.js").Err<E>|string} e
 * @returns {import("./result.js").Err<E>}
 */
 ...
 * @template T
 * @template {Error} E
 * @param {import("./result").Option<T> | import("./result.js").Result<T, E>} t
 * @returns {T|never}
 */
